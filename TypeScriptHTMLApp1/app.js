...
(function (GameFromScratch) {
    ...
    var GameRunningState = /** @class */ (function (_super) {
        ...
        GameRunningState.prototype.moveDown = function (e) {
        };
        GameRunningState.prototype.powerUp = function () {
        ...
        GameRunningState.prototype.powerDown = function () {
        ...
        GameRunningState.prototype.increasePower = function () {
            this.power++;
        ...
        GameRunningState.prototype.update = function () {
            ...
            this.game.physics.arcade.collide(this.pitchSprite, this.ball, function () { console.log("1"); });
            this.game.physics.arcade.collide(this.bird, this.pitchSprite, function () { console.log("2"); _this.rightEmitter.start(false, 5000, 20); });
    ...
    var SimpleGame = /** @class */ (function () {
        function SimpleGame() {
            this.game = new Phaser.Game(window.innerWidth * window.devicePixelRatio, window.innerHeight * window.devicePixelRatio, Phaser.CANVAS, 'canvasholder');
